...
class AbstractLevel(yaml.YAMLObject):
    ...
    def from_yaml(cls, loader, node):
        ...
        for item in loaded_data:
            _obj.config[item] = loaded_data[item]
...
for node in range(nodes):
    print('python.',
          'config:',
          Levels['levels'][node]['obj'].config,
    )

    print(Levels_yaml)
    print('YAML.',
          'config:',
          Levels_yaml['levels'][node]['obj'].config,
    )
    map = Levels_yaml['levels'][node]['map'].get_map()
    obj = Levels_yaml['levels'][node]['obj'].get_objects(map)
    print(map, obj)
